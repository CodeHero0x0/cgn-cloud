...
import com.cgn.framework.dbswitch.common.type.DBTableType;
import com.cgn.framework.dbswitch.common.type.ProductTypeEnum;
import com.cgn.framework.dbswitch.common.util.UuidUtils;
...
public final class GenerateSqlUtils {
	...
	public static String getDDLCreateTableSQL(
		...
		if (ProductTypeEnum.MYSQL.equals(type)) {
			...
			if (withRemarks && StrUtil.isNotBlank(tableRemarks)) {
