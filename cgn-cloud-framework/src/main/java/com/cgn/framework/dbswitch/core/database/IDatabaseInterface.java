...
import com.cgn.framework.dbswitch.core.model.SchemaTableData;
...
public interface IDatabaseInterface {
	 ...
	 * @return long
	 */
	int queryTableDataCount(Connection connection, String tableName);
	 ...
	 * @return boolean
	 */
	boolean dropTable(Connection connection, String tableName);
